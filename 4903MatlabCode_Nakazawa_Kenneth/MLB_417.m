%MLB_417.m
%Example of Ranking MLB, American League East Division Teams (as of 4/17/14)
...
H = [0 5/19 4/19 0 10/19;1/8 0 7/8 0 0; 10/16 2/16 0 0 4/16;9/22 0 8/22 0 5/22; 1/19 0 6/19 12/19 0];
...
disp('As of 4/17/14');
teams=teams'
TeamRankValues_417 = abs(pi)
[values team_ranking_high_to_low_index]=sort(TeamRankValues_417,'descend');
...
x=1:5;
figure
bar(x,TeamRankValues_417)
set(gca, 'XTick',1:5, 'XTickLabel',{'Baltimore', 'Boston', 'New York', 'Tampa Bay', 'Toronto'})
ylabel('Rank Values')
title('MLB, American League East Division (as of 4/17/14)')