%MLB_416.m
%Example of Ranking MLB, American League East Division Teams (as of 4/16/14)
...
H = [0 5/19 4/19 0 10/19;1/8 0 7/8 0 0; 10/16 2/16 0 0 4/16;9/14 0 0 0 5/14; 1/19 0 6/19 12/19 0];
...
disp('As of 4/16/14');
teams=teams'
TeamRankValues_416 = abs(pi)
[values team_ranking_high_to_low_index]=sort(TeamRankValues_416,'descend');
...
x=1:5;
figure
bar(x,TeamRankValues_416)
set(gca, 'XTick',1:5, 'XTickLabel',{'Baltimore', 'Boston', 'New York', 'Tampa Bay', 'Toronto'})
ylabel('Rank Values')
title('MLB, American League East Division (as of 4/16/14)')