%MLB_421.m
%Example of Ranking MLB, American League East Division Teams (as of 4/21/14)
...
H = [0 8/22 4/22 0 10/22;6/13 0 7/13 0 0; 10/37 2/37 0 21/37 4/37;9/22 0 12/26 0 5/26; 1/19 0 6/19 12/19 0];
...
disp('As of 4/21/14');
teams=teams'
TeamRankValues_421 = abs(pi)
[values team_ranking_high_to_low_index]=sort(TeamRankValues_421,'descend');
...
x=1:5;
figure
bar(x,TeamRankValues_421)
set(gca, 'XTick',1:5, 'XTickLabel',{'Baltimore', 'Boston', 'New York', 'Tampa Bay', 'Toronto'})
ylabel('Rank Values')
title('MLB, American League East Division (as of 4/21/14)')