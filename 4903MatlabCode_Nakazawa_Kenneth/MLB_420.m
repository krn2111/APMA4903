%MLB_420.m
%Example of Ranking MLB, American League East Division Teams (as of 4/20/14)
...
H = [0 8/22 4/22 0 10/22;5/12 0 7/12 0 0; 10/37 2/37 0 21/37 4/37;9/22 0 12/26 0 5/26; 1/19 0 6/19 12/19 0];
...
disp('As of 4/20/14');
teams=teams'
TeamRankValues_420 = abs(pi)
[values team_ranking_high_to_low_index]=sort(TeamRankValues_420,'descend');
...
x=1:5;
figure
bar(x,TeamRankValues_420)
set(gca, 'XTick',1:5, 'XTickLabel',{'Baltimore', 'Boston', 'New York', 'Tampa Bay', 'Toronto'})
ylabel('Rank Values')
title('MLB, American League East Division (as of 4/20/14)')