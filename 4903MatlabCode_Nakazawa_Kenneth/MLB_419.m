%MLB_419.m
%Example of Ranking MLB, American League East Division Teams (as of 4/19/14)
...
H = [0 7/21 4/21 0 10/21;5/12 0 7/12 0 0; 10/37 2/37 0 21/37 4/37;9/22 0 8/22 0 5/22; 1/19 0 6/19 12/19 0];
...
disp('As of 4/19/14');
teams=teams'
TeamRankValues_419 = abs(pi)
[values team_ranking_high_to_low_index]=sort(TeamRankValues_419,'descend');
...
x=1:5;
figure
bar(x,TeamRankValues_419)
set(gca, 'XTick',1:5, 'XTickLabel',{'Baltimore', 'Boston', 'New York', 'Tampa Bay', 'Toronto'})
ylabel('Rank Values')
title('MLB, American League East Division (as of 4/19/14)')