%MLB_418.m
%Example of Ranking MLB, American League East Division Teams (as of 4/18/14)
...
H = [0 5/19 4/19 0 10/19;5/12 0 7/12 0 0; 10/22 2/22 0 6/22 4/22;9/22 0 8/22 0 5/22; 1/19 0 6/19 12/19 0];
...
disp('As of 4/18/14');
teams=teams'
TeamRankValues_418 = abs(pi)
[values team_ranking_high_to_low_index]=sort(TeamRankValues_418,'descend');
...
x=1:5;
figure
bar(x,TeamRankValues_418)
set(gca, 'XTick',1:5, 'XTickLabel',{'Baltimore', 'Boston', 'New York', 'Tampa Bay', 'Toronto'})
ylabel('Rank Values')
title('MLB, American League East Division (as of 4/18/14)')